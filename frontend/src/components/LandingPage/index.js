    ...
    <div className="landingPage-container">
      ...
      <div className='mainImage-container'>
        ...
        <img className="discover-image" src='https://a-v2.sndcdn.com/assets/images/sc_landing_header_web_a@2x-cc048a7f.jpg' width='100%'/> 
          ...
          Discover more with SoundCloud Plus+
            <div className='sc-plus-text'> 
              SoundCloud Plus+ lets you listen offline, ad-free with over 150 million tracks - and growing.
            </div>
          </div> 
        ...
        <div className='download-container'>
          ...
          <div className='download-image-div'>
            <img className='download-main-image' src='https://chartmogul.com/blog/wp-content/uploads/2017/02/soundcloud-940x400.jpg' width='1%'/>
          ...
          <div className='never-stop-listening-container'>
            <div className='never-stop-listening-div'>
              ...
              <img className='never-stop-listening-img' src="https://a-v2.sndcdn.com/assets/images/never_stop_listening@2x-ae7903ca.jpg" />

              <div className='never-stop-listening-text'>
                <p className='nsl-text'>
                  Never stop listening
                </p>
                <img className='nsl-rainbow-line' src='https://app-name-soundcloud.herokuapp.com/images/bar.jpeg' />
