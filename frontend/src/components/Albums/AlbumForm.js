  ...
  const albumSubmit = async (e) => {
    ...
    try {
      const newAlbum = await dispatch(
        formType === "Create" ? createAlbum(form) : editAlbum(form)
      );
  ...
  return (
    <div className="album-div">
      <form className="albumForm-container" onSubmit={albumSubmit}>
        <p className="albumFormDetail-basic-info">{formType} Album</p>
        ...
        <div className="albumForm-detail">
          ...
          <div className="albumForm-info-div">
            <p className="album-info-text">Title</p>
            <div className="albumForm-field">
              <input
                type="text"
                value={title}
            ...
            <p className="album-info-text">Description</p>
            <div className="albumForm-field">
              <input
                type="text"
                value={description}
            ...
            <div className="albumForm-submit-button-div">
              <button className="albumForm-submit-button" type="submit">
                Save Changes
              </button>
            </div>
          </div>
