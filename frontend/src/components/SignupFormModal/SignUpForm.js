...
function SignupFormPage({ LoginFormModal }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (password === confirmPassword) {
      ...
      return setErrors({confirmPW:'Confirm Password field must be the same as the Password field'});
    // else {
    ...
    <form className='signup-form' onSubmit={handleSubmit}>
      ...
      <label className='verification'>
        ...
        <div className='buttonDiv'>
          <button className='signUpForm-button' type="submit">Accept & continue</button>
        </div>
        ...
        <div className='signup-form-fine-print'>
        <p className='signup-form-fine-text'> When registering, you agree that we may use your provided data for the registration and to send you notifications on our products and services. You can unsubscribe from notifications at any time in your settings. For additional info please refer to our Privacy Policy </p>
      </div>
    </form>
